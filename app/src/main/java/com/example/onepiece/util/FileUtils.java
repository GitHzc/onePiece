...
public class FileUtils {
    ...
    public static boolean writeResponseBodyToFile(String fileName, ResponseBody body) {
        try {
            File mp3File = new File(Environment.getExternalStoragePublicDirectory(DIRECTORY_MUSIC), fileName);
            createDir(mp3File.getParent());
            ...
            try {
                ...
                while (true) {
                    ...
                    Log.d(DebugMessage.TAG, "writeResponseBodyToFile: " + fileSizeDownloaded + " of " + fileSize);
                }
